                ...
                foreach (FAQDetails FAQ in FAQDetailss)
                {
                    ...
                    strFAQs += @"<tr>
                                                ...
                                                <td class='text-center'>
                                                    <a href='manage-faq.aspx?id=" + FAQ.Id + @"' class='bs-tooltip text-info fs-18' data-id='" + FAQ.Id + @"' data-toggle='tooltip' data-placement='top' title='Edit' data-original-title='Edit'>
