<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="theater-list.aspx.cs" Inherits="theater_list" %>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="breadcrumb-title text-center mb-20">
                                <h2 class="big-title">Theaters</h2>
                            </div>
