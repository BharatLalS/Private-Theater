...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection conSQ)
    {
    ...
    public static CreateUser GetUserDetails(SqlConnection conSQ, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection conSQ, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection conSQ, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection conSQ, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection conSQ, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection conSQ, string id,string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection conSQ, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection conSQ, CreateUser loginInputs)
    {
    ...
    public static CreateUser Login2(SqlConnection conSQ, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection conSQ, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection conSQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection conSQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection conSQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection conSQ, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection conSQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection conSQ, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection conSQ, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection conSQ, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection conSQ, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection conSQ, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection conSQ)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection conSQ, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(conSQ, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(conSQ, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(conSQ, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(conSQ, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(conSQ, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
