...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conSQ)
    {
    ...
    public static int InsertPageMaster(SqlConnection conSQ, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conSQ, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conSQ, PageMaster cat)
    {
        int result = 0;
