...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection conSQ)
    {
    ...
    public static int InsertPageGroup(SqlConnection conSQ, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection conSQ, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection conSQ, PageGroup cat)
    {
        int result = 0;
